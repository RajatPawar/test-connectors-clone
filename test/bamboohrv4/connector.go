...
func GetBambooHRConnector(ctx context.Context, httpClient *http.Client) *bamboohrv4.Connector {
	...
	conn, err := bamboohrv4.NewConnector(common.ConnectorParams{
